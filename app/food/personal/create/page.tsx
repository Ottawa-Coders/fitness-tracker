...
import ResultBox from "@/app/components/ResultBox/ResultBox";
...
export default function Home() {
  ...
  const handleTextChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (
      invalidValues.isNameInvalid == true &&
      name == "name" &&
      value != ""
    ) {
  ...
  const submitPersonalFood = async () => {
    ...
    const body = formValues.protein ? {...requiredBody, protein: Number(formValues.protein)} : requiredBody
    
    if (!(nameInvalid || servingSizeInvalid || servingUnitInvalid || caloriesInvalid)) {
    ...
    <main>
      <div className={styles.createFoodContainer}>
        <div className={styles.foodHeaderContainer}>
          ...
          <Link href='/food/personal' className={styles.backLink}>BACK</Link >
        </div>
        ...
        <div className={styles.foodFieldContainer}>
          <div className={styles.inputContainer}>
            <div className={styles.foodName}>
              <label>Name</label>
              <input type="text" className={`${invalidValues.isNameInvalid ? styles.isInvalid : ""}`}
                id="name"
                name="name"
            ...
            <label  className={!(invalidValues.isNameInvalid) ? styles.hiddenMessage : styles.invalidMessage}>Please insert a name for your food</label>
          </div>
          ...
          <div className={styles.inputContainer}>
            <div className={styles.foodServingSize}>
              ...
              <input className={`${invalidValues.isServingSizeInvalid ? styles.isInvalid : ""}`}
                id="servingSize"
                name="servingSize"
                type="number" 
                placeholder="Value"
                ...
                required
              />
              <input className={`${invalidValues.isServingUnitInvalid ? styles.isInvalid : ""}`}
                id="servingUnit"
                name="servingUnit"
                type="text" 
                placeholder="Unit"
            ...
            <label className={(!invalidValues.isServingSizeInvalid) && (!invalidValues.isServingUnitInvalid) ? styles.hiddenMessage : styles.invalidMessage}>Please fill out the measurements</label>
          </div>
          <hr></hr>
          <div className={styles.foodNutrition}>
            <div className={styles.foodNutritionLeft}>
              <div className={styles.foodNutritionEntry}>
                ...
                <input className={`${invalidValues.isCaloriesInvalid ? styles.isInvalid : ""}`}
                  id="calories"
                  name="calories"
                  type="numeric" 
                  placeholder="kcal"
              ...
              <label className={!(invalidValues.isCaloriesInvalid) ? styles.hiddenMessage : styles.invalidMessageNutrients}>Please insert a calorie value</label>
            </div>
          ...
          <button className={styles.submit} onClick={submitPersonalFood}>SUBMIT</button>
        </div>
      </div>
    </main>
  </>
